...
# Originally from: https://github.com/nk412/optparse
# @version : Latest commit c927f7d  on Apr 7, 2015
#
# Example Usage:
#
#    # Source the optparse lib. This may optionally be included in .bashrc to be provided everywhere... 
#    source optparse.bash
#
#    # Option argument (takes a value). This makes a global $file variable
#    optparse.define short=f long=file desc="The input file" variable=filename
#
#    # Flag argument (simply on or off) Must include the "value=true|false" var. This creates an $verbose variable with a string value of "true" or "false"
